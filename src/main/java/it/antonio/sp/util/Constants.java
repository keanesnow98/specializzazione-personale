...
public class Constants {
	...
	public static final String ROLE_USER_ANAGRAPHICVVF_SUBMIT = "ROLE_USER_ANAGRAPHICVVF_SUBMIT";
	public static final String ROLE_USER_ANAGRAPHICVVF_RESET = "ROLE_USER_ANAGRAPHICVVF_RESET";
