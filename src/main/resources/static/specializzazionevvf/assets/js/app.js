...
class ThemeCustomizer {
  ...
  initSwitchListener() {
    var self = this;
    document
      .querySelectorAll("input[name=data-sidenav-color]")
  ...
  setSwitchFromConfig() {
    ...
    if (config) {
      ...
      var layoutColorSwitch = document.querySelector(
        "input[type=radio][name=data-theme][value=" + config.theme + "]"
      );
      ...
      var leftbarColorSwitch = document.querySelector(
        "input[type=radio][name=data-sidenav-color][value=" +
          config.sidenav.color +
          "]"
      );
      ...
      var layoutSizeSwitch = document.querySelector(
